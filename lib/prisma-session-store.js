...
var PrismaSessionStore = /** @class */ (function (_super) {
    ...
    function PrismaSessionStore(prisma, options) {
        ...
        _this.set = function (sid, session, callback) { return __awaiter(_this, void 0, void 0, function () {
            var ttl, expiresAt, sessionString, existingSession, extras, data, e_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        extras = this.options.extrasFunc
                            ? this.options.extrasFunc(session)
                            : {};
                        data = __assign({ sid: sid, expiresAt: expiresAt, data: sessionString }, extras);
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 8, , 9]);
