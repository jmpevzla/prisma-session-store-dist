...
var PrismaSessionStore = /** @class */ (function (_super) {
    ...
    function PrismaSessionStore(prisma, options) {
        ...
        _this.set = function (sid, session, callback) { return __awaiter(_this, void 0, void 0, function () {
            var ttl, expiresAt, sessionString, existingSession, data, _session, sextras, objData, keys, _data, _extras, _i, keys_1, key, ekey, value, _value, et, e_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (this.options.extrasPath && this.options.extras) {
                            _session = session;
                            sextras = (0, lodash_1.get)(_session, this.options.extrasPath);
                            if (typeof sextras !== 'undefined' && this.isJson(sextras)) {
                                objData = JSON.parse(sextras);
                                keys = Object.keys(this.options.extras);
                                _data = data;
                                _extras = this.options.extras;
                    ...
                    case 8:
                        e_6 = _a.sent();
                        this.logger.error("set(): " + String(e_6));
                        // Clear flag, to indicate that set() operation
                        // is no longer in progress for this sid.
                        this.isSetting.set(sid, false);
                        if (callback)
        ...
        _this.touch = function (sid, session, callback) { return __awaiter(_this, void 0, void 0, function () {
            var ttl, expiresAt, existingSession, existingSessionData, e_7;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 6:
                        e_7 = _b.sent();
                        this.logger.error("touch(): " + String(e_7));
                        if (callback)
    ...
    PrismaSessionStore.prototype.isJson = function (data) {
        var value = typeof data !== 'string' ? JSON.stringify(data) : data;
        try {
